...
export default function Footer() {
  ...
  return (
    <footer
      ref={ref}
      className="bg-[#0a1a2b] text-white relative overflow-hidden"
    >
      {/* Decorative gradient glow */}
      <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-[#7CEB1D]/5 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -left-40 w-[400px] h-[400px] bg-[#7CEB1D]/5 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            >
              <h3 className="text-lg font-bold mb-6 text-white relative">
                Quick Links
                <span className="absolute -bottom-2 left-0 w-8 h-0.5 bg-[#7CEB1D] rounded-full" />
              </h3>
              <ul className="space-y-3">
                {quickLinks.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.path}
                      className="text-gray-400 hover:text-[#7CEB1D] transition-all duration-300 text-sm flex items-center gap-2 group"
                    >
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#7CEB1D]/10 group-hover:bg-[#7CEB1D] flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                    <Phone size={18} className="text-[#7CEB1D] group-hover:text-[#041423] transition-colors duration-300" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#7CEB1D]/10 group-hover:bg-[#7CEB1D] flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                    <Mail size={18} className="text-[#7CEB1D] group-hover:text-[#041423] transition-colors duration-300" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4 group">
                  <div className="w-10 h-10 rounded-full bg-[#7CEB1D]/10 group-hover:bg-[#7CEB1D] flex items-center justify-center flex-shrink-0 transition-colors duration-300">
                    <MapPin size={18} className="text-[#7CEB1D] group-hover:text-[#041423] transition-colors duration-300" />
                  </div>
                  <div>
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <Link
                      ...
                      className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#7CEB1D] border border-white/10 hover:border-[#7CEB1D] flex items-center justify-center transition-all duration-300 group"
                    >
                      <Icon
                        size={16}
                        className="text-gray-400 group-hover:text-[#041423] transition-colors duration-300"
                      />
                    </Link>
                  );
                })}
