    ...
    >
      {item.type === "video" ? (
        ...
        <Image
          ...
          alt={item.title}
          fill
          className="gallery-thumb object-fill"   // ✅ changed to object-contain
          sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
          onError={(e) => {
            e.currentTarget.src = videoPlaceholder;
          }}
      ...
      {/* ─── Removed overlay and video badge ───────────────────────── */}
    </div>
  );
}
